...
############################################################
# Recommend import:
#   import miaplpy.scatterview as view
...
def check_multilook_input(pixel_box, row_num, col_num):
    ...
    if row_num * col_num > 10:
        ...
        if pixel_num_per_figure > (8e6 * 160):
            multilook_num = 16;  ## 2k * 2k image with 120 subplots
        elif pixel_num_per_figure > (4e6 * 80):
            multilook_num = 8;  ## 2k * 2k image with 80  subplots
        elif pixel_num_per_figure > (4e6 * 20):
            multilook_num = 4;  ## 2k * 2k image with 40  subplots
        elif pixel_num_per_figure > (1e6 * 20):
            multilook_num = 2;  ## 2k * 2k image with 40  subplots
